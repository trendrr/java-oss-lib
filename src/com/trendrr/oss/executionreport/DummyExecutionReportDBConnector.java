...
public class DummyExecutionReportDBConnector extends
	...
	/* (non-Javadoc)
	 * @see com.trendrr.oss.executionreport.AbstractExecutionReportDBConnector#inc(byte[], com.trendrr.oss.Timeframe, java.util.Date, long, long)
	 */
	@Override
	protected void inc(byte[] id, Timeframe frame, Date timestamp, long val,
			long millis) {
	}
	 ...
	 */
	@Override
	protected List<ExecutionReportPoint> load(List<byte[]> ids) {
